...
import {
StatusDTO,TableIndicesDTO,TableItemDTO,TableItemRequestDTO,TableItemsDTO,TableQueryRequestDTO,TableScanRequestDTO,TableSchemaDTO,TablesDTO
} from "../models/index";
...
queryTable(table: string,dto: TableQueryRequestDTO): Observable<TableItemsDTO> {
...
scanTable(table: string,dto: TableScanRequestDTO): Observable<TableItemsDTO> {
